          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="班级号" prop="class_id">
                <el-input v-model="formData.class_id"></el-input>
              </el-form-item>
            </el-col>
      ...
      <el-dialog title="编辑检查项" :visible.sync="dialogFormVisible4Edit">
        ...
        >
          <el-row>
            <el-col :span="12">
              <el-form-item label="班级号" prop="class_id">
                <el-input v-model="formData.class_id" />
              </el-form-item>
            </el-col>
